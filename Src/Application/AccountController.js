(function () {
	...
	Controller.AccountController.prototype.deleteUser = function(user) {
		if (confirm("rly?")) {
			this.accountManager.remove(user);
		}
	};

	Controller.AccountController.prototype.addDummyUsers = function() {
	...
	Controller.AccountController.prototype.resetToDummies = function() {
