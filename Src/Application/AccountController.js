define(["Configuration","Model/Domain/AccountManager", "Model/Domain/Account", "Model/Domain/User"], function (Configuration, AccountManager, Account, User) {
	...
	AccountController.prototype.deleteUser = function(user) {
		if (confirm("rly?")) {
			this.accountManager.remove(user);
		}
	};
	...
	AccountController.prototype.resetToDummies = function() {
		this.accountManager.users = {};
		this.addDummyUsers();
	};
